...
import Divsquat from  './divsquat';
import Improve from  './Improve';
import Seriess from  './Series';
...
const im1={src:"https://www.docplanner.com/img/sygnet.png"}
const tab=["We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and that's why we are always next to them:to help them find the best possible care. Anytime, anywhere.","We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and that's why we are always next to them:to help them find the best possible care. Anytime, anywhere."]
const text="Making the healthcare experience more human";
const Improv=["Improve the lives of millions.Change yours forever","More than 1000 team mates share our same vision, goals and passion With offices in Warsaw, Barcelona, Istanbul, Rome, Mexico City and Curitiba, our search for great talent never stops."
]
// const tabslect=["choose country","france","Italy"]
const section=[{
  mot:"For patients",
  par:"Find a doctor, book a visit and solve any health-related doubt",
  im:"https://www.docplanner.com/img/screen-marketplace@2x.png"
},
{
  mot:"For doctros",
  par:"Find a doctor, book a visit and solve any health-related doubt",
  im:"https://www.docplanner.com/img/screen-saas@2x.png"
}
...
const seriephoto=[
  {
    name:"https://www.docplanner.com/images/warsaw.png",
    text:"warsaw",
    btn:"See opening"
  },
  {
    name:"https://www.docplanner.com/images/barcelona.png",
    text:"barcelona",
    btn:"See opening"
  },
  {
    name:"https://www.docplanner.com/images/istanbul.png",
    text:"istanbul",
    btn:"See opening"
  },
  {
    name:"https://www.docplanner.com/images/rome.png",
    text:"rome",
    btn:"See opening"
  },
  {
    name:"https://www.docplanner.com/images/mexico-city.png",
    text:"mexico",
    btn:"See opening"
  },
  {
    name:"https://www.docplanner.com/images/curitiba.png",
    text:"rcuritibia",
    btn:"See opening"
  }
]
...
<div  className="vecc">
<svg xmlns="http://www.w3.org/2000/svg" width="200" height="22" viewBox="0 0 200 32">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="167" height="22" viewBox="0 0 167 32">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="182" height="22" viewBox="0 0 182 32">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="220" height="22" viewBox="0 0 220 32">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="195" height="22" viewBox="0 0 195 32">
            <path
...
//   return(
//     <div>
//     <img  className="im1"  src={props.name.src}/>
//     </div>
//   )
//   }
  // const Img2=(props)=>{
  //   return(
  //     <div className="im2"  >
  //     <img src={props.name1.src}/>
  //     </div>
  //   )
  //   }
    //componenant of both parag
...
//         const Midd=(props)=>{
//           return(
//           <div className="midd"><h1 className="phrase">{props.name}</h1></div>
//           )
//         }
...
function App() {
  return (
    <div className="App">
      ...
      <Vecteur  />
      <Divsquat name={quatrediv}/>
      <Improve phrases={Improv}/>
      <Seriess obj={seriephoto}/>
